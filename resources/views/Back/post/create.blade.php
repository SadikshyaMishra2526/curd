                  ...
                  <form role="form" action="{{ route('post.store') }}" method="POST">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Title here" value="{{old('title') }}" name="title" id="title" class="form-control">
...
<!-- 
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="description" id="description" rows="10" name="description"  class="form-control">
