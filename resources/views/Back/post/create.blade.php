                  ...
                  <form role="form" action="{{ route('post.store') }}" method="POST">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Title here" name="title" id="title" class="form-control">
...
<!-- 
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="body" id="body" rows="10" name="body" class="form-control"></textarea>
